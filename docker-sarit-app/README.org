...
* Building the images
  ...
  If you want to build your own local docker images, it is important
 that you have previously managed to build the various submodules
 (*.xar files), e.g., from the root directory:
